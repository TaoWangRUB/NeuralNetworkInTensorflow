...
def my_input_fn(features, targets, batch_size=1, shuffle=True, num_epochs=None):
    """
    Prepare data batch feeding to the training process.
...
training_input_fn = lambda: my_input_fn(train_features_data,
                                        train_targets_data["median_house_value"],
                                        batch_size=batch_size)
testing_input_fn = lambda: my_input_fn(test_features_data,
                                       test_targets_data["median_house_value"],
                                       num_epochs=1,
                                       shuffle=False)
...
dnn_regressor = train_nn_regression_model(
    ...
    batch_size=batch_size,
    hidden_units=[10, 10],
    training_examples=train_features_data,
    training_targets=train_targets_data,
    validation_examples=test_features_data,
    validation_targets=test_targets_data)
